...
public class Enchantment_EnderDamage extends EnchantmentDamage {
    ...
    @Override
    public void func_151367_b(EntityLivingBase aHurtEntity, Entity aDamagingEntity, int aLevel) {//warning: Entity/TE, instanceof -> getClass().equals()
        if ((aHurtEntity.getClass().equals(EntityEnderman.class) || aHurtEntity.getClass().equals(EntityDragon.class) || (aHurtEntity.getClass().getName().indexOf(".") >= 0 && aHurtEntity.getClass().getName().substring(aHurtEntity.getClass().getName().lastIndexOf(".")).contains("Ender")))) {
