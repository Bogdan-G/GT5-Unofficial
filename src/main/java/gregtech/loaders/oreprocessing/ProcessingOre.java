    ...
    private boolean registerStandardOreRecipes(OrePrefixes aPrefix, Materials aMaterial, ItemStack aOreStack, int aMultiplier) {
        ...
        for (Materials tMat : aMaterial.mOreByProducts) {
            ...
            if (tPrimaryByProduct == null) {
                ...
                if (GT_OreDictUnificator.get(OrePrefixes.dustSmall, tMat, 1L) == null)//if (tPrimaryByProductSmall == null)
            ...
            //if ((tSecondaryByProduct == null)/* || (tSecondaryByMaterial == tPrimaryByMaterial)*/) {
                ...
                GT_OreDictUnificator.get(OrePrefixes.dust, tMat, 1L);//tSecondaryByProduct = GT_OreDictUnificator.get(OrePrefixes.dust, tMat, 1L);
                /*tSecondaryByProductSmall = GT_OreDictUnificator.get(OrePrefixes.dustSmall, tMat, 1L);*/
                if (GT_OreDictUnificator.get(OrePrefixes.dustSmall, tMat, 1L) == null) {//if (tSecondaryByProductSmall == null) {
                ...
                }//} //for layout AkelPad (he ignore commented "{}")
            //}
        }
        ...
        if (!tHasSmelting) {
            //tHasSmelting = GT_ModHandler.addSmeltingRecipe(aOreStack, GT_OreDictUnificator.get(OrePrefixes.gem, tMaterial.mDirectSmelting, Math.max(1, aMultiplier * aMaterial.mSmeltingMultiplier / 2)));//dead code?
