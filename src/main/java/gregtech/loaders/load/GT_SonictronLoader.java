...
public class GT_SonictronLoader
    ...
    public void run() {
        ...
        if (!gregtech.api.enums.GT_Values.Ser0) {
        ...
        GT_Mod.gregtechproxy.mSoundCounts.add(Integer.valueOf(1));
        try {
        FileOutputStream outputStream = new FileOutputStream("."+File.separator+"cache2"+File.separator+"mSoundNames.ser");
        ObjectOutputStream objectOutputStream = new ObjectOutputStream(outputStream);
        objectOutputStream.writeObject(GT_Mod.gregtechproxy.mSoundNames);
        ...
        GT_Mod.gregtechproxy.mSoundCounts.add(Integer.valueOf(1));
        try {
        FileInputStream inputStream = new FileInputStream("."+File.separator+"cache2"+File.separator+"mSoundNames.ser");
        ObjectInputStream objectInputStream = new ObjectInputStream(inputStream);
        GT_Mod.gregtechproxy.mSoundNames = (List<String>) objectInputStream.readObject();
